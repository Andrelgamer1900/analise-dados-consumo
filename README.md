# Análise de Dados de Consumo com Python
...
- O Top 5 de itens mais consumidos por categoria em cada local.

## 📁 Estrutura do Repositório
- `main.py`: Script Python contendo toda a lógica de processamento e geração de gráficos.
- `dados.xlsx`: Base de dados em formato Excel utilizada na análise.
